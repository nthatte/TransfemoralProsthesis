#ifndef BISS_ENCODER_NETZER_H
#define BISS_ENCODER_NETZER_H

/** @file
 *  @brief This driver implements communication between the xMega and a netzer Biss C encoder.
 *
...
typedef struct {
	...
	uint8_t input_buffer[4]; /**< An array of 4(8...24bit | 7...0) bytes where the data is clocked into */
 ...
 *
 *  @param encoder Pointer to the netzer encoder struct for the encoder to read
